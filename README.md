...
- `stockVote`：基于既有股票分析结果，输出角色化投票式结论
...
ln -s "/Users/hexingyuan/CodeProjects/skills/stockVote" "$CODEX_HOME/skills/stockVote"
```
...
cp -R "/Users/hexingyuan/CodeProjects/skills/stockVote" "$CODEX_HOME/skills/"
```
...
ln -s "/Users/hexingyuan/CodeProjects/skills/stockVote" ~/.claude/skills/stockVote
```
...
ln -s "/Users/hexingyuan/CodeProjects/skills/stockVote" ~/.qoder/skills/stockVote
```
